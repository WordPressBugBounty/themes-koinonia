 ...
 */
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/img_rawpixel-id-3286015.jpg","dimRatio":0,"isUserOverlayColor":true,"minHeight":100,"minHeightUnit":"vh","contentPosition":"top center","sizeSlug":"large","style":{"spacing":{"padding":{"top":"0","bottom":"var:preset|spacing|80"}}},"textColor":"tertiary","layout":{"type":"constrained"}} -->
<div class="wp-block-cover has-custom-content-position is-position-top-center has-tertiary-color has-text-color" style="padding-top:0;padding-bottom:var(--wp--preset--spacing--80);min-height:100vh"><img class="wp-block-cover__image-background size-large" alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/img_rawpixel-id-3286015.jpg" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"metadata":{"name":"Fixed Header"},"align":"full","style":{"position":{"type":"sticky","top":"0px"},"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
...
<h1 class="wp-block-heading alignwide has-text-align-left" id="oops-that-page-can-t-be-found" style="text-transform:none"><?php esc_html_e('This page can’t be found', 'koinonia');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<p><?php esc_html_e('It looks like nothing was found at this location. Try a search.', 'koinonia');?></p>
<!-- /wp:paragraph -->

<!-- wp:search {"showLabel":false,"buttonText":"SEARCH","buttonPosition":"button-inside","buttonUseIcon":true} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></main>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->